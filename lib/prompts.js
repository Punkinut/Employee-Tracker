        ...
        .prompt([
            {
                ...
                name: 'choice',
                choices: ['View All Departments','Add Department','Delete Department', 'View All Roles', 'Add Role','Delete Role', 'View All Employees','Add Employee','Update Employee Role','Delete Employee', 'View All Managers', 'Exit']
            },
        ])
        .then((res) => {
            const { choice } = res;
